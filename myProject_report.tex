...
\titleTH{ระบบตรวจสอบประกาศนียบัตรออนไลน์ด้วยไฮเปอร์เลดเจอร์ฟาบริคบล็อคเชน}
\titleEN{verification System Of E-Certificate using Hyperledger Fabric Blockchain
}

\author{นายคนธกานต์ ฟูคำ}{Konthakarn Fukam}{630610719}
\author{นายคุณาสิน เตชะสืบ}{Kunasin Techasueb}{630610721}

\cpeadvisor{trasapong}
\cpecommittee{dome}
\cpecommittee{kampol}
...
\begin{biosketch}
\begin{center}
  \includegraphics[width=1.5in]{me.png}
\end{center}
...
\begin{center}
  \includegraphics[width=1.5in]{me2.png}
\end{center}
